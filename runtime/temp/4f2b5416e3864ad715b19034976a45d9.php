<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\wamp3\wamp64\www\recruit\public/../application/companyadmin\view\talent\talentlist.html";i:1513328864;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					  ...
					  if(layEvent === 'detail'){ //查看
					    ...
					    layer.confirm('确定删除该需求么', function(index){
					    	  _ajax("<?php echo url('talentDel'); ?>",{taid:data.taid},dtd)
							  dtd.done(function(){
								  obj.del(); 
								  layer.close(index);
							  })
						  ...
						  _ajax("<?php echo url('statusChange'); ?>",{taid:data.taid,status:1},dtd)
						  dtd.done(function(){
						  ...
						  _ajax("<?php echo url('statusChange'); ?>",{taid:data.taid,status:0},dtd)
						 dtd.done(function(){
