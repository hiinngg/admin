<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\wamp3\wamp64\www\recruit\public/../application/companyadmin\view\team\teamlist.html";i:1513330649;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>团队定制需求管理</title>
...
<body  style="scroll-x:scroll;">
	...
	var tranStatus={
		...
		var articleTable = table.render({
			        ...
			        url: "<?php echo url('team/teamList'); ?>",
			        cols:[[
			         {checkbox: true},
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					  ...
					  if(layEvent === 'detail'){ //查看
					    ...
					    layer.confirm('确定删除该需求么', function(index){
					    	  _ajax("<?php echo url('teamDel'); ?>",{teamid:data.teamid},dtd)
							  dtd.done(function(){
								  obj.del(); 
								  layer.close(index);
							  })
						  ...
						  _ajax("<?php echo url('statusChange'); ?>",{teamid:data.teamid,status:0},dtd)
						 dtd.done(function(){
